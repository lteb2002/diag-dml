...
import com.reremouse.dml.solver.lp.{MultiplierLPSolverBfSumt, MultiplierLPSolverY2Julia}
...
/**
  * 测试基于乘子法求解线性规划问题
  */
object JuliaMultiplierLpY2SolveTest {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val method = new MultiplierLPSolverY2Julia()
