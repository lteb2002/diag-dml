...
import com.reremouse.dml.solver.lp.{MultiplierLPSolverBfSumt, MultiplierLPSolverPrj}
...
/**
  * 测试基于乘子法求解线性规划问题
  */
object MultiplierLpSolverPrjTest {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val method = new MultiplierLPSolverPrj()
    //val method = new BfSumtLPSolver()
    val re=method.solve(c,A,b,"L2",1)
    val ans = re._2
